...
function CloseIcon({ clearLogs }) {
  return (
    <span class="close-console" title="close window" onClick={clearLogs}>
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
        data-icon="window-close"
        class="svg-inline--fa fa-window-close fa-w-16 fa-sm "
        role="img"
        viewBox="0 0 512 512"
      >
        <path
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <CloseIcon clearLogs={this.clearLogs} />
